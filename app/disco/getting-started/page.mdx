...
1. Get a copy of the installation zip-file; there are currently binaries for <Link href="/disco-binaries/disco-x64.zip">Ubuntu Linux</Link> and <Link href="/disco-binaries/disco-armv7.zip">Raspbian</Link>.
1. Create a folder (the working directory) in some convenient location, then within this folder, create a collection of empty folders as follows: `mkdir Data History Links Local Logs Media PlayLists Reports`
...
1. Place the two binaries, discoserver and disco, in the working directory.
